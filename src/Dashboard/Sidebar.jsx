        ...
        <nav className="mt-4">
          {[
            ...
            <Link
              key={index}
              to={item.link}
              className={`flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-orange-500 hover:text-white transition-colors duration-300 ${
